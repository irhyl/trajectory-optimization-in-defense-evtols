...
\begin{figure}[t]
  \vskip 0.2in
  \begin{center}
    \includegraphics[width=\columnwidth]{../../visuals/perception/A6_fused_cost_map.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.7\textwidth]{../../visuals/planning/K1_pareto_front.png}
  \caption{NSGA-III Pareto front: energy vs.\ mission time vs.\ maximum
    ...
    solution structure that makes T6 (Pareto ranking) a non-trivial task.}
  \label{fig:pareto}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[width=0.7\textwidth]{../../visuals/vehicle/D01_energy_battery.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.7\textwidth]{../../visuals/control/A01_tracking_performance_distributions.png}
