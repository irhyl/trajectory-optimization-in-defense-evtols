...
\begin{figure}[h]
  ...
  \begin{subfigure}[b]{0.49\textwidth}
    \includegraphics[width=\textwidth]{figures/A6_fused_cost_map.png}
    \caption{Delhi fused cost field with SAM threat contours overlaid.}
    \label{fig:fused_cost}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.49\textwidth}
    \includegraphics[width=\textwidth]{figures/K1_pareto_front.png}
...
\begin{figure}[h]
  \centering
  \begin{subfigure}[b]{0.49\textwidth}
    \includegraphics[width=\textwidth]{figures/D01_energy_battery.png}
    \caption{Energy consumption and battery state-of-charge distributions.}
    \label{fig:energy_battery}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.49\textwidth}
    \includegraphics[width=\textwidth]{figures/A01_tracking_performance_distributions.png}
