"""Helper script to regenerate evtol_dataset.py in repo root."""
import os
...
with open("evtol_dataset.py", "w", encoding="utf-8") as f:
    f.write("\n".join(lines) + "\n")

print(f"evtol_dataset.py written ({len(lines)} lines)")
